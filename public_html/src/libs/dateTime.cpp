...
dateTime operator+(long seconds, const dateTime &stamp)
...
pointer params.  
------------------------------------------------------------*/
void dateTime::getAll (int &year, int &month, int &day,
...
------------------------------------------------------------*/
void dateTime::setAll (int year, int mon, int day, int hour, int min, int sec)
{       
stmp = GetJulianDays (year, mon, day) * DAYSECLL;
stmp += (hour * HOURSECLL) + (min * MINUTESECLL) + sec;
}
...
tsec = (long) (stmp % DAYSECLL);   
stmp = GetJulianDays (year, month, day) * DAYSECLL;
stmp += tsec;
}
...
------------------------------------------------------------*/
void dateTime::setToCurrent (int uselocal)
...
stmp +=  tdptr->tm_hour * HOURSECLL + tdptr->tm_min * MINUTESECLL + 
                tdptr->tm_sec;
}
